...
> Подробная инструкция для бизнес-партнёра — внутри плагина: `plugins/project-setup/skills/project-setup/ИНСТРУКЦИЯ.md`.
...
4. `git commit + push`. Узлы получают через `/plugin update`.
